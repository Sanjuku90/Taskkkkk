...
export default function AdminTransactions() {
  ...
  return (
    <AppLayout adminMode>
      ...
      {/* Legend */}
      <div className="flex flex-wrap items-center gap-4 mb-5 text-xs text-zinc-400">
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-zinc-400 uppercase bg-black/20 border-b border-white/5">
              <tr>
                ...
                <th className="px-6 py-4 font-medium">Hash / Adresse</th>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {isPremium && (
                          <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-amber-500/15 border border-amber-500/30 text-amber-400 text-[10px] font-bold uppercase tracking-wide">
                    ...
                    <td className="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                      {tx.status === 'pending' ? (
                        ...
                        <span className="text-zinc-600 italic text-xs">Traité</span>
                      )}
                    </td>
                  </tr>
                );
