...
const translations = {
  en: {
    ...
    transactions: {
      ...
      depositDesc: "Send funds to the address below and submit the transaction hash. Deposits are processed within 10 to 20 minutes.",
      ...
      warningText: "You are responsible for providing the correct wallet address. If you submit incorrect or invalid information, your funds may be permanently lost. TaskCoin cannot recover funds sent to a wrong address. Withdrawal processing takes up to 72 hours.",
  ...
  fr: {
    ...
    transactions: {
      ...
      depositDesc: "Envoyez des fonds à l'adresse ci-dessous et soumettez le hash de transaction. Les dépôts sont pris en compte entre 10 à 20 minutes.",
      ...
      warningText: "Vous êtes responsable de fournir l'adresse de portefeuille correcte. Si vous soumettez des informations incorrectes, vos fonds peuvent être définitivement perdus. TaskCoin ne peut pas récupérer des fonds envoyés à une mauvaise adresse. Le traitement des retraits prend jusqu'à 72 heures.",
