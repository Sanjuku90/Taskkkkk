...
const translations = {
  en: {
    ...
    transactions: {
      ...
      depositDesc: "Send funds to the address below and submit the transaction hash. Validation takes up to 72 hours.",
  ...
  fr: {
    ...
    transactions: {
      ...
      depositDesc: "Envoyez des fonds à l'adresse ci-dessous et soumettez le hash de transaction. La validation prend jusqu'à 72 heures.",
